...
function iLove(str, love){
	return `${str} loves ${love}`
}
...
const total = myNumbers.reduce(function(total, num){
	return total + num
})
...
// const totallyAwesome = people.reduce(function(total, person, index){
// 	return total + person[index]['awesomeLevel']
// })

const totallyAwesome = people.reduce(function(total, elem){
	total += elem.awesomeLevel
	return total
}, 0)
